...
// LOCALES
    var fe=/D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,ge="一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),he="一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),ie=Vd,je=Vd;
// FORMATTING
...
// LOCALES
    var me="星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),ne="周日_周一_周二_周三_周四_周五_周六".split("_"),oe="日_一_二_三_四_五_六".split("_"),pe=Vd,qe=Vd,re=Vd;T("H",["HH",2],0,"hour"),T("h",["hh",2],0,Qa),T("k",["kk",2],0,Ra),T("hmm",0,0,function(){return""+Qa.apply(this)+S(this.minutes(),2)}),T("hmmss",0,0,function(){return""+Qa.apply(this)+S(this.minutes(),2)+S(this.seconds(),2)}),T("Hmm",0,0,function(){return""+this.hours()+S(this.minutes(),2)}),T("Hmmss",0,0,function(){return""+this.hours()+S(this.minutes(),2)+S(this.seconds(),2)}),Sa("a",!0),Sa("A",!1),
// ALIASES
        I("hour","h"),
// PRIORITY
